...
<body>
    ...
    <header class="bg-dark py-5" id="main-header">
        <div class="container h-100 d-flex align-items-end justify-content-center w-100">
            <div class="text-center text-white w-100">
                ...
                <p class="lead fw-normal text-white-50 mb-0">Where Precision Meets Performance: Your Trusted Garage
                    Partner</p>
                <div class="col-auto mt-2">
                    <button class="btn btn-primary btn-lg rounded-0" id="send_request" type="button">Send Service
                        Request</button>
                </div>
            </div>
        </div>
    ...
    <section style="width: 100%;">
        <?php include "jeetu.html" ?>
    </section>


    <section class="py-5" style="display:block">
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <input type="search" id="search" class="form-control" placeholder="Search Service Here"
                                aria-label="Search Service Here" aria-describedby="basic-addon2">
                    ...
                    <div class="row gx-4 gx-lg-5 row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-xl-2"
                        id="service_list">
                        <?php
                        ...
                        while ($row = $services->fetch_assoc()):
                            ...
                            ?>
                            <a class="col item text-decoration-none text-dark view_service" href="javascript:void(0)"
                                ...
                                <div class="callout callout-primary border-primary rounded-0">
                                    <dl>
                                        ...
                                        <dd class="truncate-3 text-muted lh-1"><small>
